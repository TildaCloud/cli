...
running command...
$ tilda (--version)
@tildacloud/cli/0.11.0 darwin-arm64 node-v20.12.2
$ tilda --help [COMMAND]
USAGE
  $ tilda COMMAND
...
...
_See code: [src/commands/build/index.ts](https://github.com/TildaCloud/cli/blob/v0.11.0/src/commands/build/index.ts)_
...
_See code: [src/commands/build/nextjs/index.ts](https://github.com/TildaCloud/cli/blob/v0.11.0/src/commands/build/nextjs/index.ts)_
...
```
USAGE
  $ tilda deploy --apiOrigin <value> --projectDir <value> --projectSlug <value> --serviceSlug <value>
    --runtime <value> [--json]

FLAGS
  --apiOrigin=<value>    (required) [default: https://tilda.net] API origin
  --projectDir=<value>   (required) Relative path to project directory
  --projectSlug=<value>  (required) Project slug
  --runtime=<value>      (required) Runtime
  --serviceSlug=<value>  (required) Service slug
...
_See code: [src/commands/deploy/index.ts](https://github.com/TildaCloud/cli/blob/v0.11.0/src/commands/deploy/index.ts)_
...
_See code: [src/commands/login/index.ts](https://github.com/TildaCloud/cli/blob/v0.11.0/src/commands/login/index.ts)_
...
_See code: [src/commands/logout/index.ts](https://github.com/TildaCloud/cli/blob/v0.11.0/src/commands/logout/index.ts)_
