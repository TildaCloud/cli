...
running command...
$ tilda (--version)
@tildacloud/cli/0.54.0 darwin-arm64 node-v20.18.2
$ tilda --help [COMMAND]
USAGE
  $ tilda COMMAND
...
...
USAGE
  $ tilda build --apiOrigin <value> --serverDir <value> --projectDir <value> --serverEntryFile <value>
    --framework <value> --frameworkVersion <value> [--json] [--inlineIdentityJson <value>] [--rootStaticDir <value>...]
    [--underscoreNamedStaticDir <value>] [--routingConfigJson <value>] [--featureFlag <value>...] [--preserveStage]

FLAGS
  --apiOrigin=<value>                 (required) [default: https://tilda.net] API origin
  --featureFlag=<value>...            Feature flag
  --framework=<value>                 (required) Framework name
  --frameworkVersion=<value>          (required) Framework version
...
_See code: [src/commands/build/index.ts](https://github.com/TildaCloud/cli/blob/v0.54.0/src/commands/build/index.ts)_
...
_See code: [src/commands/build/astro/index.ts](https://github.com/TildaCloud/cli/blob/v0.54.0/src/commands/build/astro/index.ts)_
...
_See code: [src/commands/build/nextjs/index.ts](https://github.com/TildaCloud/cli/blob/v0.54.0/src/commands/build/nextjs/index.ts)_
...
_See code: [src/commands/build/nuxt/index.ts](https://github.com/TildaCloud/cli/blob/v0.54.0/src/commands/build/nuxt/index.ts)_
...
_See code: [src/commands/build/qwik/index.ts](https://github.com/TildaCloud/cli/blob/v0.54.0/src/commands/build/qwik/index.ts)_
...
_See code: [src/commands/build/static/index.ts](https://github.com/TildaCloud/cli/blob/v0.54.0/src/commands/build/static/index.ts)_
...
_See code: [src/commands/build/svelte/index.ts](https://github.com/TildaCloud/cli/blob/v0.54.0/src/commands/build/svelte/index.ts)_
...
_See code: [src/commands/deploy/index.ts](https://github.com/TildaCloud/cli/blob/v0.54.0/src/commands/deploy/index.ts)_
...
_See code: [src/commands/deployment-key/create/index.ts](https://github.com/TildaCloud/cli/blob/v0.54.0/src/commands/deployment-key/create/index.ts)_
...
_See code: [src/commands/login/index.ts](https://github.com/TildaCloud/cli/blob/v0.54.0/src/commands/login/index.ts)_
...
_See code: [src/commands/logout/index.ts](https://github.com/TildaCloud/cli/blob/v0.54.0/src/commands/logout/index.ts)_
